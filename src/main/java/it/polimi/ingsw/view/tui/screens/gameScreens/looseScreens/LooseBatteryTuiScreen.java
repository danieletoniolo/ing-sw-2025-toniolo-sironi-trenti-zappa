...
public class LooseBatteryTuiScreen extends GameTuiScreen {
    private static boolean reset;
    private static List<Integer> batteryIDs;
    private final TuiScreenView nextScreen;

    public LooseBatteryTuiScreen(TuiScreenView nextScreen) {
        super(new ArrayList<>(){{
            if (!reset) {
    ...
    public TuiScreenView setNewScreen() {
        ...
        if (selected == num) {
            destroyStatic();
            return new LooseBatteryTuiScreen(nextScreen);
        }
