...
public record RemoveLobby(
    ...
    /**
     * This method is used to create a responder for the RemoveLobby it.polimi.ingsw.event.
     ...
     * @return            a Responder for the RemoveLobby it.polimi.ingsw.event.
     */
    ...
    /**
     * Creates a Requester for the RemoveLobby it.polimi.ingsw.event.
     *
     * @param transceiver the EventTransceiver that will be used to send and receive events
     * @param lock        the object used to synchronize and manage responses
     * @return a Requester for the RemoveLobby it.polimi.ingsw.event
     */
