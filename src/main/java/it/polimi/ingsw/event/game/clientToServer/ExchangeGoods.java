...
/**
 * This it.polimi.ingsw.event is used when a player have to exchange goods between two storages.
...
public record ExchangeGoods(
    ...
    /**
     * This method is used to create a responder for the ExchangeGoods it.polimi.ingsw.event.
     ...
     * @return            a Responder for the ExchangeGoods it.polimi.ingsw.event.
     */
    ...
    /**
     * Creates a Requester for the ExchangeGoods it.polimi.ingsw.event.
     *
     * @param transceiver the EventTransceiver that will be used to send and receive events
     * @param lock        the object used to synchronize and manage responses
     * @return a Requester for the ExchangeGoods it.polimi.ingsw.event
     */
