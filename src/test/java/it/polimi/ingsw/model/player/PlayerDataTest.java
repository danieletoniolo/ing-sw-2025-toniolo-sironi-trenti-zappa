...
class PlayerDataTest {
    ...
    void getUsername(UUID username) {
        player = new PlayerData("p1", username.toString(), PlayerColor.BLUE, ship);
        assertEquals("p1", player.getUsername());
    }
    ...
    void getColor(PlayerColor color) {
        player = new PlayerData("p1", "123e4567-e89b-12d3-a456-426614174001", color, ship);
        assertEquals(color, player.getColor());
    }

    @Test
    void setStep() {
        player = new PlayerData("p1", "123e4567-e89b-12d3-a456-426614174001", PlayerColor.BLUE, ship);
        player.setStep(5);
        assertEquals(5, player.getStep());
        assertEquals(0, player.getColor().getValue());
    }
    ...
    void testEquals() {
        player = new PlayerData("p1", "123e4567-e89b-12d3-a456-426614174001", PlayerColor.BLUE, ship);
        PlayerData player2 = new PlayerData("p2", "123e4567-e89b-12d3-a456-426614174001", PlayerColor.BLUE, ship);
        assertEquals(player, player2);

        player2 = new PlayerData("p1", "123e4567-e89b-12d3-a456-426614174002", PlayerColor.BLUE, ship);
    ...
    void fromInt_correctPlayerColorForValidValues(int value) {
        PlayerColor p = PlayerColor.fromInt(value);
        assertNotNull(p);
    ...
    void fromInt_forInvalidValues_PlayerColor(int value) {
        assertThrows(IllegalArgumentException.class, () -> PlayerColor.fromInt(value));
    }

    @Test
    void getFreeColor() {
        PlayerColor[] colors = {PlayerColor.BLUE, PlayerColor.GREEN, PlayerColor.RED};
        PlayerColor freeColor = PlayerColor.getFreeColor(colors);
        assertNotNull(freeColor);
        assertEquals(PlayerColor.YELLOW, freeColor);
    }
