...
class LifeSupportPurpleTest {
    ...
    LifeSupportPurpleTest() throws NoSuchFieldException {
    }
    ...
    @Test
    void testLifeSupportPurpleConstructor() throws IllegalAccessException {
        LifeSupportPurple a = new LifeSupportPurple();
        assertNotNull(a);
