...
class TilesManagerTest {
    ...
    void getTiles() {
        ...
        assertThrows(IndexOutOfBoundsException.class, () -> TilesManager.getTile(-1));

        Component tile = TilesManager.getTile(0);
        Component tileClone = TilesManager.getTile(0);
        assertNotSame(tile, tileClone);
        assertEquals(tile.getID(), tileClone.getID());
    }
