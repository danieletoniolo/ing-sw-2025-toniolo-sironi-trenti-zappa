...
class BatteryTest {
    ...
    void getConnection_northFace() {
        ...
        assertEquals(1, component.getConnection(0).getValue());
        assertEquals(0, component.getConnection(1).getValue());
    }
    ...
    void fromInt_ConnectorTypeMethod(int value) {
        ConnectorType type = ConnectorType.fromInt(value);
        assertNotNull(type);
