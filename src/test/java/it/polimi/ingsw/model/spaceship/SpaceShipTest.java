...
class SpaceShipTest {
    ...
    @Test
    void getCannonStrenght(){
        SpaceShip s = new SpaceShip(Level.LEARNING, PlayerColor.BLUE);

        assertEquals(0, s.getCannonsStrength(List.of()));

        Cannon cannon1 = new Cannon(1, connectors, 1);
        s.placeComponent(cannon1, 6, 7);
        assertEquals(1, s.getCannonsStrength(List.of(cannon1.ID)));

        Cannon cannon2 = new Cannon(2, connectors, 2);
        s.placeComponent(cannon2, 6, 8);
        assertEquals(3, s.getCannonsStrength(List.of(cannon1.ID, cannon2.ID)));

        s.destroyComponent(6, 8);
        assertEquals(1, s.getCannonsStrength(List.of(cannon1.ID)));
    }

    @Test
    void getEnginesStrenght(){
        SpaceShip s = new SpaceShip(Level.LEARNING, PlayerColor.BLUE);

        assertEquals(0, s.getEnginesStrength(List.of()));

        Engine engine1 = new Engine(1, connectors, 1);
        s.placeComponent(engine1, 6, 7);
        assertEquals(1, s.getEngine(1).getEngineStrength());
        assertEquals(1, s.getEnginesStrength(List.of(engine1.ID)));

        Engine engine2 = new Engine(2, connectors, 2);
        s.placeComponent(engine2, 6, 8);
        assertEquals(3, s.getEnginesStrength(List.of(engine1.ID, engine2.ID)));
    ...
    void goods_afterAddingSingleGood() {
        ...
        ship.exchangeGood(List.of(good), null, s.getID());
    ...
    void goods_afterAddingMultipleGoods() {
        ...
        Storage s = new Storage(1, connectors, true, 2);
        ship.placeComponent(s, 6, 7);
        ship.exchangeGood(List.of(good1, good2), null, s.getID());
    ...
    @Test
    void addCrewMember_addBothAliens() {
        Cabin cabin = new Cabin(1, connectors);
        ship.placeComponent(cabin, 6, 7);
    ...
    @Test
    void addCrewMember_addCrewMemberToNonExistentCabin() {
    ...
    void getComponent_invalidCoordinates() {
        assertThrows(IllegalArgumentException.class, () -> ship.getComponent(12, 12));
    }
    ...
    void getCabins_afterAddingSingleCabin() {
        ...
        assertEquals(cabin, ship.getCabins().getFirst());
    }
    ...
    void getCabins_afterAddingMultipleCabins() {
        ...
        assertEquals(cabin1, ship.getCabins().get(0));
        assertEquals(cabin2, ship.getCabins().get(1));
    }
    ...
    @Test
    void pollGood_returnsMostValuableGood() {
        Storage storage = new Storage(1, connectors, true, 3);
        ship.placeComponent(storage, 6, 7);
        Good good1 = new Good(GoodType.BLUE);
        Good good2 = new Good(GoodType.RED);
        storage.addGood(good1);
        storage.addGood(good2);
        assertEquals(good2, ship.pollGood(1));
    }

    @Test
    void pollGood_forInvalidStorageID() {
        assertThrows(IllegalArgumentException.class, () -> ship.pollGood(999));
    }

    @Test
    void putReserveComponent_addsComponentToReservedList() {
        Component component = new Storage(1, connectors, true, 2);
    ...
    @Test
    void putReserveComponent() {
        Component component1 = new Storage(1, connectors, true, 2);
        Component component2 = new Battery(2, connectors, 3);
        ship.putReserveComponent(component1);
        ship.putReserveComponent(component2);
    ...
    @Test
    void putReserveComponent_whenReservingMoreThanTwoComponents() {
        Component component1 = new Storage(1, connectors, true, 2);
        Component component2 = new Battery(2, connectors, 3);
        Component component3 = new Cannon(3, connectors, 1);
        ship.putReserveComponent(component1);
        ship.putReserveComponent(component2);
        assertThrows(IllegalStateException.class, () -> ship.putReserveComponent(component3));
    }

    @Test
    void removeReserveComponent() {
        Component component1 = new Storage(1, connectors, true, 2);
        Component component2 = new Battery(2, connectors, 3);
        ship.putReserveComponent(component1);
        ship.putReserveComponent(component2);
        ship.removeReserveComponent(1);
        assertEquals(1, ship.getReservedComponents().size());
        assertEquals(component2, ship.getReservedComponents().getFirst());
    }

    @Test
    void peekReservedComponent() {
        Component component1 = new Storage(1, connectors, true, 2);
        Component component2 = new Battery(2, connectors, 3);
        ship.putReserveComponent(component1);
        ship.putReserveComponent(component2);
        assertEquals(component1, ship.peekReservedComponent(1));
        assertEquals(component2, ship.peekReservedComponent(2));
    }

    @Test
    void peekReservedComponent_returnsNullForNonExistentId() {
        Component component1 = new Storage(1, connectors, true, 2);
        ship.putReserveComponent(component1);
        assertNull(ship.peekReservedComponent(999));
    }

    @Test
    void getLastPlacedComponent() {
        Component component = new Storage(1, connectors, true, 2);
        ship.placeComponent(component, 6, 7);
        assertEquals(component, ship.getLastPlacedComponent());
    }

    @Test
    void getLastPlacedComponent_whenNoComponentPlaced() {
        assertThrows(IllegalStateException.class, () -> ship.getLastPlacedComponent());
    }

    @Test
    void getLastPlacedComponent_updatesAfterMultiplePlacements() {
        Component component1 = new Storage(1, connectors, true, 2);
        Component component2 = new Battery(2, connectors, 3);
        ship.placeComponent(component1, 6, 7);
        ship.placeComponent(component2, 6, 8);
        assertEquals(component2, ship.getLastPlacedComponent());
    }
